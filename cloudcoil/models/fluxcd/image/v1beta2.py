...
class ImagePolicyStatus(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def observed_previous_image(self, value: Optional[str], /) -> Self:
            """
    ...
    observed_previous_image: Annotated[Optional[str], Field(alias="observedPreviousImage")] = None
    """
    ObservedPreviousImage is the observed previous LatestImage. It is used
    to keep track of the previous and current images.
    """
...
class ImageRepositorySpec(BaseModel):
    ...
    been deprecated.
    """
    exclusion_list: Annotated[Optional[List[str]], Field(alias="exclusionList", max_length=25)] = [
        "^.*\\.sig$"
    ]
    """
    ExclusionList is a list of regex strings used to exclude certain tags
...
class LastScanResult(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def latest_tags(self, value: Optional[List[str]], /) -> Self:
...
class ImageRepositoryStatus(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def observed_exclusion_list(self, value: Optional[List[str]], /) -> Self:
            """
    ...
    observed_exclusion_list: Annotated[
        Optional[List[str]], Field(alias="observedExclusionList")
    ] = None
    """
    ObservedExclusionList is a list of observed exclusion list. It reflects
    the exclusion rules used for the observed scan result in
...
class Commit(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def message_template_values(self, value: Optional[Dict[str, str]], /) -> Self:
            """
    ...
    message_template_values: Annotated[
        Optional[Dict[str, str]], Field(alias="messageTemplateValues")
    ] = None
    """
    MessageTemplateValues provides additional values to be available to the
    templating rendering.
...
class PolicySelector(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["PolicySelector"]:
            return PolicySelector

        def build(self) -> "PolicySelector":
            return PolicySelector(**self._attrs)

        @overload
        def match_expressions(
            self, value_or_callback: List[MatchExpression], /
        ) -> "PolicySelector.Builder": ...
    ...
    class BuilderContext(BuilderContextBase["PolicySelector.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = PolicySelector.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for PolicySelector."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["PolicySelector", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use PolicySelector.list_builder() instead."
            )
...
class ImageUpdateAutomationSpec(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def policy_selector(
            self, value_or_callback: Optional[PolicySelector], /
        ) -> "ImageUpdateAutomationSpec.Builder": ...
        ...
        def policy_selector(
            self,
            value_or_callback: Callable[
                [PolicySelector.Builder], PolicySelector.Builder | PolicySelector
            ],
            /,
        ) -> "ImageUpdateAutomationSpec.Builder": ...
        ...
        def policy_selector(
            self, value_or_callback: Never = ...
        ) -> "PolicySelector.BuilderContext": ...

        def policy_selector(self, value_or_callback=None, /):
            """
            PolicySelector allows to filter applied policies based on labels.
            By default includes all policies in namespace.
            """
            if self._in_context and value_or_callback is None:
                context = PolicySelector.BuilderContext()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(PolicySelector.builder())
                if isinstance(output, PolicySelector.Builder):
                    value = output.build()
                else:
                    value = output
    ...
    run should be attempted.
    """
    policy_selector: Annotated[Optional[PolicySelector], Field(alias="policySelector")] = None
    """
    PolicySelector allows to filter applied policies based on labels.
    By default includes all policies in namespace.
    """
...
class ObservedPolicies(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["ObservedPolicies"]:
            return ObservedPolicies

        def build(self) -> "ObservedPolicies":
            return ObservedPolicies(**self._attrs)
    ...
    class BuilderContext(BuilderContextBase["ObservedPolicies.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = ObservedPolicies.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for ObservedPolicies."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["ObservedPolicies", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use ObservedPolicies.list_builder() instead."
            )
...
class ImageUpdateAutomationStatus(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def observed_policies(self, value: Optional[Dict[str, ObservedPolicies]], /) -> Self:
            """
        ...
        def observed_source_revision(self, value: Optional[str], /) -> Self:
            """
    ...
    observed_policies: Annotated[
        Optional[Dict[str, ObservedPolicies]], Field(alias="observedPolicies")
    ] = None
    """
    ObservedPolicies is the list of observed ImagePolicies that were
    considered by the ImageUpdateAutomation update process.
    """
    observed_source_revision: Annotated[Optional[str], Field(alias="observedSourceRevision")] = None
    """
    ObservedPolicies []ObservedPolicy `json:"observedPolicies,omitempty"`
    ObservedSourceRevision is the last observed source revision. This can be
    used to determine if the source has been updated since last observation.
...
class ImagePolicy(Resource):
    class Builder(BaseModelBuilder):
        ...
        def api_version(
            self, value: Optional[Literal["image.toolkit.fluxcd.io/v1beta2"]], /
        ) -> Self:
            """
    ...
    api_version: Annotated[
        Optional[Literal["image.toolkit.fluxcd.io/v1beta2"]], Field(alias="apiVersion")
