...
class Verify(BaseModel):
    ...
    provider: Optional[Literal["cosign"]] = "cosign"
    """
    Provider specifies the technology used to sign the OCI Helm chart.
    """
...
class HelmReleaseSpec(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def chart(self, value_or_callback: Chart, /) -> "HelmReleaseSpec.Builder": ...
...
class HelmReleaseStatus(BaseModel):
    ...
    last_attempted_release_action: Annotated[
        Optional[str], Field(alias="lastAttemptedReleaseAction")
    ] = None
    """
    LastAttemptedReleaseAction is the last release action performed for this
    HelmRelease. It is used to determine the active remediation strategy.
    ...
    the last successful reconciliation attempt.
    """
    storage_namespace: Annotated[Optional[str], Field(alias="storageNamespace")] = None
    """
    StorageNamespace is the namespace of the Helm release storage for the
    current release.
...
class HelmRelease(Resource):
    class Builder(BaseModelBuilder):
        ...
        def api_version(
            self, value: Optional[Literal["helm.toolkit.fluxcd.io/v2beta1"]], /
        ) -> Self:
            """
    ...
    api_version: Annotated[
        Optional[Literal["helm.toolkit.fluxcd.io/v2beta1"]], Field(alias="apiVersion")
