...
class Verify(BaseModel):
    class Builder(BaseBuilder):
        ...
        def provider(self, value: Optional[Literal["cosign"]]) -> Self:
...
class HelmReleaseSpec(BaseModel):
    class Builder(BaseBuilder):
        ...
        def chart(
            self,
            value_or_callback: Union[Chart, Callable[[Chart.Builder], Chart.Builder]],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
...
class HelmReleaseStatus(BaseModel):
    class Builder(BaseBuilder):
        ...
        def last_attempted_release_action(self, value: Optional[str]) -> Self:
...
class HelmRelease(Resource):
    class Builder(BaseBuilder):
        ...
        def api_version(self, value: Optional[Literal["helm.toolkit.fluxcd.io/v2beta1"]]) -> Self:
            return self._set("api_version", value)
    ...
    api_version: Annotated[
        Optional[Literal["helm.toolkit.fluxcd.io/v2beta1"]],
        Field(
            alias="apiVersion",
