...
class Verify(BaseModel):
    ...
    mode: Annotated[
        Optional[Literal["head", "HEAD", "Tag", "TagAndHEAD"]],
        Field(
...
class GitRepositorySpec(BaseModel):
    class Builder(BaseBuilder):
        ...
        def provider(self, value: Optional[Literal["generic", "azure"]]) -> Self:
            return self._set("provider", value)
    ...
    provider: Annotated[
        Optional[Literal["generic", "azure"]],
        Field(
...
class GitRepositoryStatus(BaseModel):
    ...
    source_verification_mode: Annotated[
        Optional[str],
        Field(
            alias="sourceVerificationMode",
...
class Bucket(Resource):
    ...
    api_version: Annotated[
        Optional[Literal["source.toolkit.fluxcd.io/v1"]],
        Field(
            alias="apiVersion",
